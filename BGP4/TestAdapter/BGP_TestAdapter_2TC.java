 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class BGP_TestAdapter_2TC extends TestAdapter implements TriCommunicationSA,TriPlatformPA, TciEncoding 
{
	 ...
	 */
	 public void triCancel()	//when the testcase execute the "stop" statement, then this function done
	 {
	     synchronized (threadlock)
		     {
			    if(runThread_pco1||runThread_pco2)
			    {
				     if(runThread_pco1)
			...
			try
			{
				...
				tcpReceiverThread_pco1 = new Thread()
				{
					public void run() 
					{
						...
						try 
						{
							rxSocket_pco1.setSoTimeout(10000);			  
							while (mylock) 
							{
